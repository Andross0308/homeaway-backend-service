...
public class LodgingServiceClass extends ServiceClass implements EatingLodgingService{
     ...
     */
    public LodgingServiceClass(long lat, long log, int price, int capacity, String name, int lastChanged){
        super(ServiceTypeEnum.LODGING, lat, log, name, lastChanged);
        this.price = price;
    ...
    /**
     * Verifies if the service has still space for a new student
     * Best Case: O(1);
     * Worst Case: O(1);
     * Average Case: O(1);
     ...
     * @throws ServiceHasNoStudents if there is no students currently in the service
     */
    @Override
